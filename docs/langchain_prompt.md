...
TOOLS:
The only external tool you may call is search_api(query), and only when one of the following is true:
...
Return the final result via the structured response schema. Do not print extra commentary
